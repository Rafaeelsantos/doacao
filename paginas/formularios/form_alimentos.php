...
<style>
    .page-bg {
        background: linear-gradient(180deg, #f6fff8 0%, #e8f9e9 100%);
        min-height: 100vh;
        padding: 28px 24px;
...
<div class="page-bg">
    <div class="form-card">
        ...
        <div class="form-body">
            <form id="formDoacao" action="processar_formulario/processar_forms.php" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="tipo" value="alimentos">
                ...
                <label for="quantidade">Quantidade de Itens <span style="color:red">*</span></label>
                <input id="quantidade" name="quantidade" type="number" placeholder="Ex: 5 cestas básicas" required>

                <label for="endereco">Endereço para Coleta <span style="color:red">*</span></label>
                ...
                <textarea id="mensagem" name="mensagem"
                    placeholder="Deixe uma mensagem de esperança e solidariedade..."></textarea>
...
<script>
    ...
    // Validação do endereço e telefone
